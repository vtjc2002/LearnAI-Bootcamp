...
This lab, **Dialogs and Regex**, is under maintenance. The hands-on activiites won't work, since the EchoBot template changed. To complete this training, please follow the workaround steps below:
